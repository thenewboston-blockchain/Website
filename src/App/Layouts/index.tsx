    ...
    return (
        <div className="app-main-toolbar">
            ...
            <div className="app-main-toolbar__tools">
                <AppButton onClick={() => setMenuOpen(!isMenuOpen)} className="app-guide-layout__menu-button"><AppIcon icon="dots-vertical" /></AppButton>
            </div>
            <div onClick={() => setMenuOpen(false)} className={`app-main-toolbar__scrim ${isMenuOpen && 'app-main-toolbar__scrim--show'}`}></div>
        </div>
    );
}
...
export const FixedToolbarLayout = ({ children }) => {
    return (
        <div className="app-basic-layout">
            ...
            <main className="app-basic-layout__content--fixed">
                {children}
            </main>
        </div>
    );
        ...
        <div className="app-basic-layout app-guide-layout">
            <AppToolbar className="app-basic-layout__toolbar app-basic-layout__toolbar--fixed">
                <div className="app-guide-layout__toolbar-container">
                    <AppButton onClick={() => setMenuOpen(!isMenuOpen)} className="app-guide-layout__menu-button"><AppIcon icon="menu" /></AppButton>
                    <LayoutToolbarContent></LayoutToolbarContent>
                </div>
            </AppToolbar>
            ...
            <div onClick={() => setMenuOpen(false)} className={`app-guide-layout__scrim ${isMenuOpen && 'app-guide-layout__scrim--show'}`}></div>
