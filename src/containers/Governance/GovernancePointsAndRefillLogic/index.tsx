...
import {DocContainer, TableBorderGrid} from 'components';
  ...
  return (
    <DocContainer className="GovernancePointsAndRefillLogic" title="Points And Refill Logic" lastUpdated="07 Mar 2021">
      <p>
        ...
        global nodes which is needed for validation. In our network, time is measured in blocks. This method of
        measurement will fluctuate heavily early on (in relation to human time) but will become more accurate as the
        network grows.
      </p>
      <p>
        <strong>Time</strong> <br />1 network day = 1,000 blocks
      </p>
      <p>
      ...
      <p>This results in a 100% point refill every 4 network days.</p>
      <TableBorderGrid
        headers={['Events', 'Point Balance']}
        rows={[
          ['User locks 24 coins', '2,400,000 (refill rate of 600,000 points/day)'],
          ['User spends 2,000,000 points', '400,000'],
