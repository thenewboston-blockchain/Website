  ...
  return (
    <>
      ...
      <div className="PrivacyPolicy">
        ...
        <h2 className="PrivacyPolicy__subtitle">Collecting Your Personal Data</h2>
        ...
        <ul className="PrivacyPolicy__list">
          <li>
            the personal data you provide when you register to use our website, including your name, postal address,
        ...
        <div>
          ...
          <ul className="PrivacyPolicy__list">
            <li>
              <strong>Essential Cookies.</strong> These cookies are essential to provide you with services available
              through our website and to enable you to use some of its features. For example, they allow you to login to
              secure areas of our website and help the content of the pages you request load quickly. Without these
            ...
            <li>
              ...
              operate our website more efficiently, to gather broad demographic information and to monitor the level of
              activity on our website. We use Google Analytics for this purpose. Google Analytics uses its own cookies.
              It is only used to improve how our website works. You can find out more information about Google Analytics
              cookies here:{' '}
              <A href="https://developers.google.com/analytics/resources/concepts/gaConceptsCookies" newWindow={false}>
                https://developers.google.com/analytics/resources/concepts/gaConceptsCookies
              </A>{' '}
              You can find out more about how Google protects your data here:{' '}
              <A href="https://policies.google.com/privacy" newWindow={false}>
                https://policies.google.com/privacy
              </A>
              . You can prevent the use of Google Analytics relating to your use of our website by downloading and
              installing the browser plugin available via this link:{' '}
              <A href="http://tools.google.com/dlpage/gaoptout?hl=en-GB" newWindow={false}>
                http://tools.google.com/dlpage/gaoptout?hl=en-GB
              </A>
              .
            </li>
            <li>
              <strong>Targeted and advertising cookies.</strong> These cookies track your browsing habits to enable us
        ...
        <div>
          ...
          <ul className="PrivacyPolicy__list">
            ...
            <li>
              to manage your account, including to communicate with you regarding your account, if you have an account
              on our website
            </li>
            <li>
            ...
            <li>
              ...
              applicable laws; (b) to comply with lawful requests and legal process, including to respond to requests
              from public and government authorities; (c) to enforce our Policy; and (d) to protect our rights, privacy,
        ...
        <h2 className="PrivacyPolicy__subtitle">Sharing Your Personal Data</h2>
        <div>
          ...
          <ul className="PrivacyPolicy__list">
            ...
            <li>
              <strong>Our Third Party Service Providers.</strong> We may share your personal data with our third party
              service providers who provide services such as data analysis, payment processing, information technology
              and related infrastructure provision, customer service, email delivery, auditing and other similar
              services.
            </li>
            <li>
        ...
        <div>
          ...
          If you wish to exercise any of these rights, please contact us. In your request, please make clear: (i) what
          personal data is concerned; and (ii) which of the above rights you would like to enforce. For your protection,
          we may only implement requests with respect to the personal data associated with the particular email address
          that you use to send us your request, and we may need to verify your identity before implementing your
          request. We will try to comply with your request as soon as reasonably practicable and in any event, within
          one month of your request. Please note that we may need to retain certain information for recordkeeping
          purposes and/or to complete any transactions that you began prior to requesting such change or deletion.
        </div>
        <h2 className="PrivacyPolicy__subtitle">Complaints</h2>
        <p>
        ...
        <h2 className="PrivacyPolicy__subtitle">Contact Information</h2>
        <p>
