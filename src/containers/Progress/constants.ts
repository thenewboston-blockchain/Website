...
export const dummyIssues: BaseIssue[] = [
  ...
  },
  {
    ...
    node_id: 'MDU6SXNzdWU4NTQxNDM3Nzk=',
    number: 139,
    title: 'Create weekly progress page to update the community about our progress',
    user: {
      login: 'buckyroberts',
      id: 8547538,
      node_id: 'MDQ6VXNlcjg1NDc1Mzg=',
    ...
    assignees: [
      ...
      },
      {
        ...
        id: 8547599,
        node_id: 'MDQ6VXNlcjg1NDc1Mzg=',
        avatar_url: 'https://avatars.githubusercontent.com/u/32864116?v=4',
        gravatar_id: '',
        url: 'https://api.github.com/users/jamessspanggg',
        html_url: 'https://github.com/jamessspanggg',
        followers_url: 'https://api.github.com/users/jamessspanggg/followers',
        following_url: 'https://api.github.com/users/jamessspanggg/following{/other_user}',
        gists_url: 'https://api.github.com/users/jamessspanggg/gists{/gist_id}',
        starred_url: 'https://api.github.com/users/jamessspanggg/starred{/owner}{/repo}',
        subscriptions_url: 'https://api.github.com/users/jamessspanggg/subscriptions',
        organizations_url: 'https://api.github.com/users/jamessspanggg/orgs',
        repos_url: 'https://api.github.com/users/jamessspanggg/repos',
        events_url: 'https://api.github.com/users/jamessspanggg/events{/privacy}',
        received_events_url: 'https://api.github.com/users/jamessspanggg/received_events',
        type: 'User',
        site_admin: false,
      },
    ],
