...
const NodeIdentifier = () => (
  <section className="NodeIdentifier">
    ...
    <p>
      ...
      <NavLink to="/bank-api/connection-requests">connection request</NavLink> process. A sample connection request body
      can be seen below.
    </p>
  ...
  "signature": "3c88665e123e7e25a8b9d9592f3269ab4efc4bcba989a103a898e2625933261b1cccdaf2f52eca9c58d2bf033968ab6b702089bca8fc6e0c80b3b002a5e05b03"
    ...
    <p>
      Given the structure of the request, clients with access to the NID signing key can initiate connection requests on
      behalf of their node by sending requests directly from a client application to the target nodes. This also allows
      node owners to easily manage multiple nodes from the same client application. Users maintaining multiple nodes can
      simply import the NID signing keys of all nodes they wish to manage.
    </p>

    <div className="img-container">
      <img alt="connection nid" className="connection-nid" src={ConnectionNID} />
    </div>
    ...
    <p>
      ...
      able to include this identifier in sensitive requests to other nodes to prove that the request has been authorized
      by the owner of that node.
    </p>
