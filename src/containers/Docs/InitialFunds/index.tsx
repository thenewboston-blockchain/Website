...
import './InitialFunds.scss';

const InitialFunds = () => {
  return (
    <section className="InitialFunds">
      ...
      <p>
        Choosing who would receive the initial funds was another challenge. What was the most fair way to choose the
        ...
        often diluted by the unequal distribution of that value towards the world's most wealthy individuals. In order
        to ensure that the initial distribution of funds are given not to the already wealthy, but rather to those most
        deserving, funds will be allocated to the individuals who contribute the most towards the growth and improvement
        of the network, the developers.
      </p>
      ...
      <ol>
        ...
        <ol type="a">
          <li>the account must be created prior to the date of this papers publication</li>
          <ol type="i">
            <li>
              this will prevent the creation of new GitHub accounts simply for the purpose of obtaining more funds
            </li>
          </ol>
          <li>the account has a public repository meeting the following sub-requirements:</li>
          <ol type="i">
        ...
        <ol type="a">
          ...
          <li>
            at the end of the four weeks banks will remain incentivized to stay live on the network as a result of their
      ...
      <p>
        ...
        in regards to the early adoption and development of the network. As stated above, both developers (owners of
        ...
        network. This however leaves out other individuals who have an interest in the technology or desire to help out
        the network through other means. These may include graphic designers, UX designers, marketing professionals,
        content (guides, tutorials, etc...) creators, or individuals simply interested in the technology who would like
        their own accounts. These Treasury funds will be distributed along with a transaction description detailing the
      ...
      <p>
        ...
        the rest of the network through any effective means (most likely social networks) and all users should leave the
        network by shutting down all owned banks. This will ensure that the Treasury will always be held responsible for
        their actions and any attempt to use the Treasury for personal gain would result in the immediate loss, both in
      ...
      <p>
        ...
        a trusted account on an as-needed basis, and those points will then be further distributed to others. All
