...
const AppDetailsTopSection: FC<Props> = ({className, description, logoUrl, title, websiteUrl}) => {
  ...
  return (
    <div className={clsx('AppDetailsTopSection', className)}>
      <Container className="AppDetailsTopSection__container">
        <div
          className="AppDetailsTopSection__back"
        ...
        <div className="AppDetailsTopSection__main">
          ...
          <div className="AppDetailsTopSection__details-container">
            ...
            <div
              ...
              tabIndex={0}
            >
              <span className="AppDetailsTopSection__app-website-text">
                {isWebsiteHovered ? websiteUrl : 'Website'}
              </span>
              <Icon
