...
const ConsensusCV = () => {
  return (
    <div className="ConsensusCV">
      ...
      <li className="ArchitectureDeepDive__point">
        <span className="ArchitectureDeepDive__emphasized-text">Step 2</span> - When the other CVs receive a majority of
        halt requests, the receiving CV will halt production of their blockchain.
      </li>
      <Divider className="ArchitectureDeepDive__point-divider" />
      <li className="ArchitectureDeepDive__point">
        <span className="ArchitectureDeepDive__emphasized-text">Step 3</span> - After stopping production, that CV will
...
for that minority to have any longer blockchain, given that a majority consensus must be reached to append a block to the
 blockchain. Given the status of the halted CVs where each of their HEAD blocks are known, this would be impossible."
      ...
      <Divider className="ArchitectureDeepDive__point-divider" />
      <li className="ArchitectureDeepDive__point">
        <span className="ArchitectureDeepDive__emphasized-text">Step 7</span> - Once synced, CVs send out a sync switch
        request.
      </li>
      <Divider className="ArchitectureDeepDive__point-divider" />
      <li className="ArchitectureDeepDive__point">
        <span className="ArchitectureDeepDive__emphasized-text">Step 8</span> - When the majority of CVs receive a sync
